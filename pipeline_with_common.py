...
def dataprep_with_common() -> tuple[str, str]:
    """
    Data preparation component with common utilities.
    Outputs train and test dataset paths.
    """
...
def train_with_common(train_data: Input[Dataset]) -> tuple[str, str]:
    """
...
def score_with_common(model: Input[Model], test_data: Input[Dataset]) -> tuple[str, str]:
    """
...
def ml_pipeline_with_common():
    ...
    train_task = train_with_common(train_data=dataprep_task.outputs['output_0'])
